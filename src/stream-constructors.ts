...
export interface StreamConstructors<R> {
  /**
     ...
     * @api public
     */
  constructor(): StreamImpl<R>;

  constructor(source: Array<R>): StreamImpl<R>;

  constructor(source: ValueGenerator<R>): StreamImpl<R>;

  constructor(source: Stream<R>): StreamImpl<R>;
  ...
  constructor(source: PromiseLike<Stream<R>>): StreamImpl<R>;

  constructor(source: PromiseLike<R>): StreamImpl<R>;

  constructor(source: Iterable<R>): StreamImpl<R>;

  constructor(source: Iterator<R>): StreamImpl<R>;
}
